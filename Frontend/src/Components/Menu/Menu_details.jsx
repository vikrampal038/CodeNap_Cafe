...
const Menu_details = () => {
  ...
  const menuItems = [
    { id: 1, name: "Cappuccino", price: "$99.00", image: Cappuccino, categories: ["black", "gold"] },
    { id: 2, name: "Americano", price: "$149.00", image: Americano, categories: ["black", "gold"] },
    { id: 3, name: "Conpana", price: "$299.00", image: Conpana, categories: ["organic"] },
    { id: 4, name: "Affogato", price: "$349.00", image: Affogato, categories: ["organic", "sweet"] },
    { id: 5, name: "Espresso", price: "$399.00", image: Espresso, categories: ["gold", "black"] },
    { id: 6, name: "Ristresto", price: "$449.00", image: Ristresto, categories: ["cream"] },
    { id: 7, name: "Mocha", price: "$249.00", image: Mocha, categories: ["cream", "sweet"] },
    { id: 8, name: "Lungo", price: "$199.00", image: Lungo, categories: ["sweet", "black"] },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-6">
          {filteredItems.length > 0 ? (
            filteredItems.map((item) => (
              <div
                key={item.id}
                className="flex gap-6 items-center bg-[#6b4c4c] p-4 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 hover:scale-105"
              >
                ...
                <div>
                  ...
                  <p className="text-md text-[#DACAB5]">
                    Price: <span className="text-[#E5594C] text-xl">{item.price}</span>
                  </p>
                </div>
              </div>
            ))
          ) : (
            <p className="text-center text-[#F5E7CC] text-lg">No items available in this category.</p>
          )}
        </div>
      </div>
    </div>
